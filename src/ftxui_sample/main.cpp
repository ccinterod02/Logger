...
// configuration step. It creates a namespace called `Logger`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Logger::cmake::project_name, Logger::cmake::project_version) };
